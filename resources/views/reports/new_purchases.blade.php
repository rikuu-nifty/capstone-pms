...
{{-- Table --}}
<table width="100%" cellspacing="0" cellpadding="5" style="text-align:center;">
    <thead>
        ...
        <tr>
            ...
            <th style="width:80px; text-align:center;">MR No.</th>
            <th style="width:120px; text-align:center;">SUPPLIER</th>
            <th style="text-align:center;">ITEM / DESCRIPTION</th>
            <th style="width:120px; text-align:center;">UNIT / DEPT</th>
            <th style="width:50px; text-align:center;">QTY</th>
            <th style="width:100px; text-align:center;">UNIT COST</th>
    ...
    <tbody>
        ...
        'archived' => '#EA580C', // orange
        'missing' => '#DC2626', // red
        default => '#555555', // gray fallback
        };
        @endphp
        <tr>
            <td>

          ...
          <DropdownMenuItem key={n.id} asChild>
            <div className="group relative flex w-full items-start gap-3 px-4 py-3 transition hover:bg-gray-50">
              ...
              <Link
                ...
                method="post"
                as="button"
                className="absolute right-3 top-1/2 hidden -translate-y-1/2 rounded-md bg-red-100 px-2 py-1 text-xs text-red-600 transition group-hover:flex hover:bg-red-200"
              >
                Dismiss
              </Link>
            </div>

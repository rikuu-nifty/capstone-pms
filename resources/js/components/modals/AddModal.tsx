...
const AddModal: React.FC<AddModalProps> = ({ show, onClose, title, onSubmit, processing, children }) => {
    return (
        <div className={`fixed inset-0 z-50 flex transition-all duration-300 ease-in-out ${show ? 'visible' : 'invisible'}`}>
            ...
            <div
                className={`
                    relative ml-auto w-full max-w-3xl transform bg-white shadow-xl transition-transform duration-300 ease-in-out dark:bg-zinc-900

                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-x-6 gap-y-4 pb-6 text-sm">
                        ...
                        <div className="col-span-2">
                            ...
                            <Select<AssetOption, true>
                                ...
                                className="text-sm"
                                isClearable
                                // Disable new selections when limit reached
                                isOptionDisabled={isOptionDisabled}
                                // keep the menu open while selecting until we hit the limit
                                ...
                                onChange={(selected) => {
                                    ...
                                    // hard-enforce the limit even if react-select lets more through
                                    const limited = maxSelectable ? picked.slice(0, maxSelectable) : [];

...
// import { Role, RoleManagementPageProps, RoleWithCounts, Paginator, LinkItem } from "@/types/role";
...
export default function RoleManagement() {
    const { props, url } = usePage<RoleManagementPageProps>();

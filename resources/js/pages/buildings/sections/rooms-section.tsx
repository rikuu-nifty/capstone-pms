...
import { isStringKey, ROOM_PAGE_SIZE, roomNumberKey, roomSortOptions, roomStringKey, type RoomSortKey } from './building-index.helpers';
...
export default function RoomsSection({
    ...
    useEffect(() => {
        setRoomPage(1);
    }, [roomSearch, roomSortKey, roomSortDir, selectedBuildingId]);
                                ...
                                {r.description ?? '—'}
                                    ...
                                    <TableCell className="h-full">
                                        <div className="flex h-full items-center justify-center gap-2">
                                            {canUpdate && (
                                                <Button variant="ghost" size="icon" className="cursor-pointer" onClick={() => onEditRoomClick(r)}>
                                                    <Pencil className="h-4 w-4" />
                                                </Button>
                                            )}

                                            {canDelete && (
                                                <Button variant="ghost" size="icon" onClick={() => onDeleteRoomClick(r)} className="cursor-pointer">
                                            ...
                                            >
                                                <Link
                                                    href={
                                                        canViewAll
                                                            ? route('building-rooms.view', r.id)
                                                            : canViewOwn

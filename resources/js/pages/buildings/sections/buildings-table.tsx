...
export default function BuildingsTable({
    buildings, sortKey, sortDir, search,
    selectedBuildingId, onSelect, onEdit, onDelete,
}: Props) {
                          ...
                          >
                            ...
                            <TableCell className="h-full">
                                <div className="flex justify-center items-center gap-2 h-full">
                                  ...
                                  <Button variant="ghost" size="icon" asChild className="cursor-pointer" onClick={(e) => e.stopPropagation()}>

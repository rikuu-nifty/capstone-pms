...
export function ViewMemorandumReceiptModal({ open, onClose, assets, memo_no }: Props) {
    ...
    const reqLocation = first.building_room?.room
    ...
    return (
        <ViewModal open={open} onClose={onClose} size="xl" contentClassName="relative max-h-[85vh] overflow-y-auto print:overflow-visible">
                ...
                <table className="w-full text-sm">
                    <thead className="bg-gray-100">
                        <tr className="divide-x divide-black border-b border-black">
                            <th className="w-[40%] px-3 py-2 text-left">Description of item/s, Brand</th>
                            <th className="w-[6rem] px-3 py-2 text-center">QTY</th>
                            <th className="w-[10rem] px-3 py-2 text-right">Total cost</th>
                    ...
                    <tbody>
                        ...
                        <tr className="border-t border-black">
                            <td colSpan={4} className="px-3 py-2">
                                <span className="font-semibold">Date purchased:</span> <span className="font-medium">{formattedDate}</span>
